...
{
    public class CrystalHuntEnemyBountyContent : CrystalHuntLevelBountyContent
    {
        ...
        public CrystalHuntEnemyBountyContent() { }

        public CrystalHuntEnemyBountyContent(Creature creature)
        {
